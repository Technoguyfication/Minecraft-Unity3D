...
### Hand Drawn Icons - https://www.flaticon.com/packs/hand-drawn
```
Made by Freepik (https://www.flaticon.com/authors/freepik) - flaticon.com
```

### Ionic.Zlib - https://github.com/jstedfast/Ionic.Zlib
The following license information applies only to the aforementioned library:
```
...
### "Minecrafter" Font - https://www.dafont.com/minecrafter.font
```
